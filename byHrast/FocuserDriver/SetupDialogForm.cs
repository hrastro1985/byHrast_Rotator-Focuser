...
namespace ASCOM.byHrast.Focuser
{
    ...
    public partial class SetupDialogForm : Form
    {
        ...
        private void CmdOK_Click(object sender, EventArgs e) // OK button event handler
        {
            ...
            {
                Focuser.SerialPortName = (string)comboBoxComPort.SelectedItem;
        ...
        private void InitUI()
        {
            ...
            if (comboBoxComPort.Items.Contains(Focuser.SerialPortName))
            {
                comboBoxComPort.SelectedItem = Focuser.SerialPortName;
            }
